This code (second version witth necessary corrections applied) aims to process satellite images from different sensors and calculate different burn severity indices for fires which burned from 1984 to 2022 in Portugal. 
Based on the year in which the fires burned and the availibility of satellite imgery, different sensors have been used: 
...
The fire data- perimeter/bound, start/end date, area, year of burning- have been imported into GEE as assests and have been used as a table: 
...
This code can only be used after the publication/citation of the manuscript entitled:"Multidecadal satellite-derived Portuguese Burn Severity Atlas (1984 -2022) ", ESSD, written by Jahanianfard.D, et al (2024). 
